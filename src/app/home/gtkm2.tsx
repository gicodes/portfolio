...
export const msco = <>
  ...
  <p>&#x2022; Write REST APIs and design data flow for backend services </p>
  <p>&#x2022; Integrate new libraries and functionalities for frontend apps </p>
  <p>&#x2022; Manage Domains, Infrastructure and Microservices with Docker </p>
...
export const fut = <>
  ...
  <p>&#x2022; Typescript -- Writing javascript apps with strict and safer types </p>
  <p>&#x2022; Material UI -- Styling applications with in-built react components </p>
  <p>&#x2022; Flutter -- Building cross-platform (iOS & android) apps with Dart and deploying it to the app store</p>
  <p>&#x2022; Docker -- Containerizing and deploying applications in a single image</p>
